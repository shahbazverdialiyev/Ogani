...
{
    public class UsefulLinkCreateValidator:AbstractValidator<UsefulLinkCreateDTO>
    {
        public UsefulLinkCreateValidator()
        {
            RuleFor(x => x.Name)
            ...
            RuleFor(x => x.Section)
                .IsInEnum().WithMessage("Please select a section.");
        }
    }
}
