...
{
    public class EFCoreSocialLinkRepository : EFCoreRepository<SocialLink, int>, ISocialLinkRepository
    {
        public EFCoreSocialLinkRepository(OganiDbContext context) : base(context) { }
    }
}
